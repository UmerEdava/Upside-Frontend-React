            ...
            <Stack spacing={4}>
              ...
              <Stack spacing={10}>
                <Stack
                  ...
                  <Link to={RouteNames.forgotPassword.path} color={'blue.400'}>Forgot password?</Link>
                </Stack>
                <Button
              ...
              <Stack pt={6}>
                <Text align={'center'}>
                  Don't have an account? <Link to={RouteNames.signup.path} style={{color: 'purple'}}>Sign up</Link>
                </Text>
              </Stack>
            </Stack>
          </Box>
